...
export function generateEmbed(client: DiscordClient, guildId: string, leave?: boolean) {
    ...
    const embeds = [
        ...
        .setImage("https://media.discordapp.net/attachments/937561428926275594/937636248162566194/3de14e1f6105e0fe78f6cf16a221cec4.png?width=560&height=280")
    ...
    if (!leave && player && player.queue && player.queue.current) {
        ...
        .setTitle(`**__Queue List:__** [${player.queue.length} Tracks]`)
        .setColor("GREEN")
